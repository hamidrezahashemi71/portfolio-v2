...
export default function WorkSliderBtns({ isFirst, isLast }: { isFirst: boolean, isLast: boolean }) {
        ...
        >
            {
                !isFirst && <button
                    ...
                    className="bg-light-accent dark:bg-dark-accent hover:bg-light-accent-hover hover:dark:bg-dark-accent-hover text-light-primary
                     dark:text-dark-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
                >
                    <PiCaretLeftBold />
                </button>}
            {
